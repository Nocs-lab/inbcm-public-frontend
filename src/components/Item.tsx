...
// @ts-expect-error - core não possui tipagem
import * as core from "@govbr-ds/core/dist/core-base"
...
const Item = React.forwardRef<ItemRef, ItemProps>(
  (
    ...
    // @ts-expect-error - BRItem não possui tipagem
    ...
    return (
      <>
        ...
        {subItems && (
          <List
            hidden={!expanded && collapsable}
            aria-hidden={!expanded && collapsable}
          >
            {subItems}
          </List>
        )}
